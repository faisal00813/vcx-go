...
typedef void (*cb_string)(vcx_command_handle_t cmd_handle, vcx_error_t error_code, const char* str_value);
typedef void (*cb_int)(vcx_command_handle_t cmd_handle, vcx_error_t error_code, unsigned int int_value);
typedef void (*cb_int_string)(vcx_command_handle_t cmd_handle, vcx_error_t error_code, unsigned int int_value, const char* str_value);
typedef void (*cb_enum)(vcx_command_handle_t cmd_handle, vcx_error_t error_code, vcx_state_t enum_value);
typedef void (*cb_error_code)(vcx_command_handle_t cmd_handle, vcx_error_t error_code);
...
// #Returns
// Error code as a u32
vcx_error_t vcx_init(vcx_command_handle_t command_handle, const char *config_path, cb_error_code);
...
// #Returns
// Error code as a u32
vcx_error_t vcx_ledger_get_fees(vcx_command_handle_t command_handle, cb_string);
...
// #Returns
// Error code as a u32
vcx_error_t vcx_wallet_open_search(vcx_command_handle_t command_handle,
                                const char *type_,
...
// }],
// }
vcx_error_t vcx_wallet_search_next_records(vcx_command_handle_t command_handle,
                                        vcx_wallet_search_handle_t wallet_search_handle,
                                        count_t count,
                                        cb_string);
...
// #Returns
// Error code as a u32
vcx_error_t vcx_wallet_validate_payment_address(vcx_command_handle_t command_handle,
